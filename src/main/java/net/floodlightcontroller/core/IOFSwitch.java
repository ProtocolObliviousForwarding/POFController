 ...
 *      Change short portNumber to int portId
 *      Change OFStatisticsRequest to OFMultipartRequest
 */
...
public interface IOFSwitch {
     ...
     * @return port object
     */
    public OFPhysicalPort getPort(int portId);
     ...
     * @throws IOException 
     */
    public Future<List<OFStatistics>> getStatistics(OFMultipartRequest request)
            throws IOException;
