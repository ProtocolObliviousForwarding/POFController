 ...
 */
public class OFNiciraRoleExperimenterData extends OFNiciraExperimenterData {
     ...
     */
    public OFNiciraRoleExperimenterData() {
        super();
    }
     ...
     * @param dataType
     */
    public OFNiciraRoleExperimenterData(int dataType) {
        super(dataType);
    }
     ...
     */
    public OFNiciraRoleExperimenterData(int dataType, int role) {
        super(dataType);
        this.role = role;
    }
    /**
