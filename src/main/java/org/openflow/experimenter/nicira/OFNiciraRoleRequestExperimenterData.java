 ...
 */
public class OFNiciraRoleRequestExperimenterData extends OFNiciraRoleExperimenterData {
    ...
    protected static Instantiable<OFExperimenterData> instantiable =
            new Instantiable<OFExperimenterData>() {
                public OFExperimenterData instantiate() {
                    return new OFNiciraRoleRequestExperimenterData();
                }
            };
     ...
     */
    public OFNiciraRoleRequestExperimenterData() {
     ...
     */
    public OFNiciraRoleRequestExperimenterData(int role) {
