 ...
 */
public class OFNiciraExperimenterData implements OFExperimenterData {

    public static final int NX_EXPERIMENTER_ID = 0x00002320;
    /**
     ...
     */
    public OFNiciraExperimenterData() {
    }
     ...
     */
    public OFNiciraExperimenterData(int dataType) {
